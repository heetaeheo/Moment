...
import com.example.memoapp.presentation.util.noRippleClickable
...
fun ChatScreen(
    ...
    val isPast by remember(uiState.dateKey, uiState.todayKey) {
        derivedStateOf {
            val date = uiState.dateKey.toLocalDateOrNull()
            val today = uiState.todayKey.toLocalDateOrNull()

            date != null && today != null && date.isBefore(today)
        }
    }
            ...
            TopAppBar(
                title = {
                    Row(
                        ...
                        Image(
                            imageVector = ImageVector.vectorResource(R.drawable.ic_calendar_left),
                            contentDescription = null,
                            modifier = Modifier
                                .noRippleClickable(
                                    viewModel::loadPreviousDate
                                )
                        )
                        ...
                        if (isPast) {
                            Image(
                                imageVector = ImageVector.vectorResource(R.drawable.ic_calendar_right),
                                contentDescription = null,
                                modifier = Modifier
                                    .noRippleClickable(
